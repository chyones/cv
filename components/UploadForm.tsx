...
export function UploadForm() {
  ...
  return (
    <form
      onSubmit={onSubmit}
      noValidate
      className="relative overflow-hidden rounded-2xl border border-navy/10 bg-white/95 p-5 shadow-card-lg backdrop-blur-sm sm:p-6"
    >
      ...
      <div className="mt-4">
        ...
        <div
          ...
          onDrop={onDrop}
          className={`group relative rounded-xl border-2 border-dashed px-6 py-3 text-center transition-all duration-200 focus-within:ring-4 focus-within:ring-navy/10 ${
            dragActive
        ...
        >
          ...
          {file ? (
            <div key={file.name + file.size} className="anim-pop flex flex-col items-center gap-1">
            ...
            <div className="flex flex-col items-center">
              <span className="mb-2 flex h-10 w-10 items-center justify-center rounded-full bg-navy/[0.06] text-navy transition-all duration-200 group-hover:bg-navy/10 motion-safe:group-hover:-translate-y-0.5">
              ...
              <p id={`${fileInputId}-hint`} className="mt-1 text-xs text-ink/45">
